...
class YouTubeClient(BaseClient):
    ...
    Fetches videos from a specified YouTube channel using the RSS feed endpoint.
    """
    ...
    def __init__(self, channel_id=None):
        ...
        Args:
            channel_id (str, optional): YouTube channel ID. Defaults to RottenTomatoesINDIE.
        """
    ...
    def get_videos(self):
        """Fetch videos from YouTube. Alias for get_data()."""
